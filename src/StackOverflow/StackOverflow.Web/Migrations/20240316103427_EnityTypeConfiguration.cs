...
{
    /// <inheritdoc />
    public partial class EnityTypeConfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwitterUsername = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    GitHubUsername = table.Column<string>(type: "nvarchar(39)", maxLength: 39, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswersCount = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
