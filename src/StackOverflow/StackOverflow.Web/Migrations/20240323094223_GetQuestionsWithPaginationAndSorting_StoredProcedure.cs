...
{
    /// <inheritdoc />
    public partial class GetQuestionsWithPaginationAndSorting_StoredProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"
							CREATE PROCEDURE [dbo].[GetQuestionsWithPaginationAndSorting]
						    @pageNumber INT,
						    @pageSize INT,
        ...
        {
	        var sql = @"DROP PROCEDURE [dbo].[GetQuestionsWithPaginationAndSorting]";
	        migrationBuilder.Sql(sql);
        }
    }
}
